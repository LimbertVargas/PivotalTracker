...
public class RestClientApi {
    ...
    public Response apiResponse(final String httpMethod, final String endPoint) {
        return request.given().spec(request).when().request(httpMethod, endPoint);
    }
     ...
     */
    public Response apiResponsePost(final String endpoint, final JSONObject valuesForTheBody) {
